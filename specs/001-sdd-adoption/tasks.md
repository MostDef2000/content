...
- [x] T006 Запушить артефакты в `main` (после `commit approved`) — c7bce9d.
- [x] T007 Проверить, что деплой-флоу агента ссылается на SDD-точки входа (issue #1 комментарий).
- [x] T008 Маршрутизация фронта: РУ-хост 82.146.37.153 (issue #1, комментарий 13.09); домен `3d.mostdef.ru`; все файлы переведены с NL/VPS на РУ.
